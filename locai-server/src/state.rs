...
impl AppState {
    ...
    pub fn message_matches_filters(
        ...
        if let Some(filters) = self.websocket_subscriptions.get(connection_id) {
            match message {
                WebSocketMessage::MemoryCreated {
                    memory_type,
                    importance,
                    content,
                    ..
                ...
                WebSocketMessage::MemoryUpdated {
                    content,
                    importance,
                    ..
                } => {
                ...
                WebSocketMessage::EntityCreated {
                    entity_type,
                    properties,
                    ..
                }
                | WebSocketMessage::EntityUpdated {
                    entity_type,
                    properties,
                    ..
                } => {
                ...
                WebSocketMessage::RelationshipCreated {
                    relationship_type,
                    source_id,
                    target_id,
                    ..
