...
impl CliArgs {
    ...
    pub fn parse() -> Self {
        ...
        .long_about(r#"Locai Server provides a REST API and WebSocket interface for the Locai 
  ...
  locai-server --messaging-disabled --log-level debug"#)
            .arg(
                Arg::new("port")
                    ...
                    .long_help("Port number for the HTTP server to listen on. 
Environment variable: LOCAI_PORT")
            ...
            .arg(
                Arg::new("config")
                    ...
                    .long_help("Path to the configuration file. The file can contain 
...
Environment variable: LOCAI_CONFIG_FILE")
            ...
            .arg(
                Arg::new("enable_auth")
                    ...
                    .long_help("Enable JWT-based authentication system. When enabled, 
...
Environment variable: LOCAI_ENABLE_AUTH")
            ...
            .arg(
                Arg::new("no_auth")
                    ...
                    .long_help("Disable authentication entirely. All API endpoints 
...
or trusted environments.")
            ...
            .arg(
                Arg::new("allow_signup")
                    ...
                    .long_help("Allow new users to register accounts via the signup API. 
...
Environment variable: LOCAI_ALLOW_SIGNUP")
            ...
            .arg(
                Arg::new("root_password")
                    ...
                    .long_help("Set the password for the root user account. If not 
...
Environment variable: LOCAI_ROOT_PASSWORD")
            ...
            .arg(
                Arg::new("jwt_secret")
                    ...
                    .long_help("Secret key used for signing JWT tokens. Should be a 
...
Environment variable: LOCAI_JWT_SECRET")
            ...
            .arg(
                Arg::new("jwt_expiration")
                    ...
                    .long_help("How long JWT tokens remain valid before expiring. 
Default is 24 hours.
Environment variable: LOCAI_JWT_EXPIRATION_HOURS")
            ...
            .arg(
                Arg::new("rate_limit")
                    ...
                    .long_help("Maximum number of requests per minute allowed from 
...
Environment variable: LOCAI_RATE_LIMIT_RPM")
            ...
            .arg(
                Arg::new("websocket_timeout")
                    ...
                    .long_help("How long to keep WebSocket connections alive without 
...
Environment variable: LOCAI_WEBSOCKET_TIMEOUT")
            ...
            .arg(
                Arg::new("enable_live_queries")
                    ...
                    .long_help("Enable SurrealDB live queries for real-time data 
...
Environment variable: LOCAI_ENABLE_LIVE_QUERIES")
            ...
            .arg(
                Arg::new("messaging_enabled")
                    ...
                    .long_help("Enable the built-in messaging system for real-time 
...
Environment variable: LOCAI_MESSAGING_ENABLED")
            ...
            .arg(
                Arg::new("messaging_no_auth")
                    ...
                    .long_help("Allow unauthenticated access to the messaging system. 
...
Environment variable: LOCAI_MESSAGING_AUTH_REQUIRED")
            ...
            .arg(
                Arg::new("max_request_size")
                    ...
                    .long_help("Maximum size allowed for HTTP request bodies. 
...
Environment variable: LOCAI_MAX_REQUEST_SIZE")
            ...
            .arg(
                Arg::new("log_level")
                    ...
                    .value_name("LEVEL")
                    .help("Logging level")
                    .long_help("Set the logging level. Valid values: error, warn, info, debug, trace
Environment variable: RUST_LOG")
            ...
            .arg(
                Arg::new("help_env")
                    ...
                    .long_help("Display a comprehensive list of all environment variables 
that can be used to configure the server.")
    ...
    fn print_env_help() {
        ...
        println!("  LOCAI_MAX_REQUEST_SIZE            - Max request body size in bytes (default: 16MB)");
        println!("  LOCAI_CONFIG_FILE                 - Path to config file (default: config.json)");
        println!("  LOCAI_RATE_LIMIT_RPM              - Rate limit per minute (default: 1000)");
        println!("  LOCAI_WEBSOCKET_TIMEOUT           - WebSocket timeout in seconds (default: 300)");
        println!();
        println!("Authentication:");
        println!("  LOCAI_ENABLE_AUTH                 - Enable authentication (default: true)");
        println!("  LOCAI_JWT_SECRET                  - JWT signing secret (auto-generated if not set)");
        ...
        println!("  LOCAI_ROOT_PASSWORD               - Root user password (auto-generated if not set)");
        println!();
        ...
        println!("  LOCAI_MESSAGING_ENABLE_CROSS_APP  - Enable cross-app messaging (default: true)");
        println!("  LOCAI_MESSAGING_AUTH_REQUIRED     - Require auth for messaging (default: true)");
        println!("  LOCAI_MESSAGING_MAX_MESSAGE_SIZE  - Max message size in bytes (default: 1MB)");
        println!("  LOCAI_MESSAGING_CONNECTION_TIMEOUT - Connection timeout in seconds (default: 60)");
        println!("  LOCAI_MESSAGING_HEARTBEAT_INTERVAL - Heartbeat interval in seconds (default: 30)");
