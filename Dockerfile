# Multi-stage Dockerfile for Locai Server with sccache support
# Optimized for size and build speed using host sccache cache
#
# Build with: DOCKER_BUILDKIT=1 docker build -f Dockerfile.sccache -t locai-server:latest .
#
...
LABEL org.opencontainers.image.description="Memory management service with graph-centric design (sccache optimized, 95%+ cache hit rate)"
