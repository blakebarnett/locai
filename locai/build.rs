...
fn main() {
    ...
    println!("cargo:warning=Target OS: {}, Architecture: {}", target_os, target_arch);
...
fn configure_rocksdb(_target: &str, target_os: &str, target_arch: &str) {
    match (target_os, target_arch) {
        ("linux", "x86_64") => {
            ...
            // Use LLD linker for faster linking on x86_64 Linux
        ...
        _ => {
            println!("cargo:warning=Unknown platform {}/{} - using default configuration", target_os, target_arch);
        }
    }
}
