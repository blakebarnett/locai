...
mod tests {
    use crate::config::{
        LocaiConfig, ConfigBuilder, GraphStorageType, VectorStorageType,
        LogLevel, validation
    };
    ...
    fn test_default_config() {
        ...
        assert_eq!(config.storage.graph.storage_type, GraphStorageType::SurrealDB);
        assert_eq!(config.storage.vector.storage_type, VectorStorageType::SurrealDB);
    ...
    fn test_config_builder_with_memory() {
        ...
        assert_eq!(config.storage.data_dir, PathBuf::from("/tmp/test_data"));
        assert_eq!(config.storage.graph.storage_type, GraphStorageType::SurrealDB);
        assert_eq!(config.storage.vector.storage_type, VectorStorageType::Memory);
        assert_eq!(config.ml.embedding.model_name, "test-model");
        assert_eq!(config.logging.level, LogLevel::Debug);
    }
    ...
    fn test_predefined_configs() {
        ...
        assert_eq!(dev.storage.vector.storage_type, VectorStorageType::SurrealDB);
    ...
    fn test_predefined_configs_production() {
        ...
        assert_eq!(prod.storage.vector.storage_type, VectorStorageType::SurrealDB);
    ...
    fn test_config_serialization() {
        ...
        assert_eq!(config.ml.embedding.model_name, deserialized.ml.embedding.model_name);
    }
} 