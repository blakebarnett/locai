...
use crate::storage::filters::{MemoryFilter, SemanticSearchFilter, EntityFilter, RelationshipFilter};
use crate::storage::models::{MemoryGraph, MemoryPath, Relationship, SearchResult, Entity};
use crate::models::{Memory, MemoryType, MemoryPriority, MemoryBuilder};
...
use crate::memory::{
    ...
    search_extensions::{SearchExtensions, SearchMode, UniversalSearchResult, UniversalSearchOptions},
...
impl MemoryManager {
    ...
    pub fn new(storage: Arc<dyn crate::storage::traits::GraphStore>, ml_service: Option<Arc<EmbeddingManager>>, config: LocaiConfig) -> Self {
        // Initialize all the component modules
        let memory_ops = MemoryOperations::new(Arc::clone(&storage), ml_service.clone(), config.clone());
    ...
    #[cfg(any(feature = "surrealdb-embedded", feature = "surrealdb-remote"))]
    pub async fn new_with_ml(storage: Arc<dyn crate::storage::traits::GraphStore>, ml_service: Option<Arc<EmbeddingManager>>, config: LocaiConfig) -> Result<Self> {
        // Initialize memory operations with ML extractors
        let memory_ops = MemoryOperations::new_with_ml(Arc::clone(&storage), ml_service.clone(), config.clone()).await?;
        let builders = MemoryBuilders::new(Arc::new(memory_ops.clone()));
        let search = SearchExtensions::new(Arc::clone(&storage));
        let graph = GraphOperations::new(Arc::clone(&storage));
        let entities = EntityOperations::new(Arc::clone(&storage));
    ...
    pub async fn initialize_ml_extractors(&mut self) -> Result<()> {
        tracing::info!("🤖 ML extractor initialization called - this is a no-op, use MemoryManager::new_with_ml() instead");
        Ok(())
    }
    ...
    {
        self.builders.add_memory_with_options(content, options).await
    }
    ...
    pub async fn add_memory_with_priority<S: Into<String>>(
        ...
        self.builders.add_memory_with_priority(content, memory_type, priority).await
    }
    ...
    pub async fn search(
        ...
        self.search.search(query_text, limit, filter, search_mode).await
    }
    ...
    pub async fn search_with_embedding(
        ...
        self.search.search_with_embedding(query_text, query_embedding, limit, filter, search_mode).await
    }
    ...
    {
        self.search.search_memories_with_options(character_name, filter_options, limit).await
    }
    ...
    pub async fn find_paths(&self, from_id: &str, to_id: &str, max_depth: u8) -> Result<Vec<MemoryPath>> {
        self.graph.find_paths(from_id, to_id, max_depth).await
    }
    
    /// Find the shortest path between two memories
    pub async fn find_shortest_path(&self, from_id: &str, to_id: &str, max_depth: u8) -> Result<Option<MemoryPath>> {
        self.graph.find_shortest_path(from_id, to_id, max_depth).await
    }
    
    /// Find all memories connected to this memory by a specific relationship
    pub async fn find_connected_memories(&self, id: &str, relationship_type: &str, max_depth: u8) -> Result<Vec<Memory>> {
        self.graph.find_connected_memories(id, relationship_type, max_depth).await
    }
    ...
    pub async fn create_relationship(
        ...
        self.graph.create_relationship(source_id, target_id, relationship_type).await
    }
    ...
    pub async fn create_bidirectional_relationship(
        ...
        self.graph.create_bidirectional_relationship(memory_id1, memory_id2, relationship_type).await
    }
    ...
    pub async fn add_related_memory<S: Into<String>>(
        ...
        self.graph.add_related_memory(parent_id, content, relationship_type, memory_type, &self.memory_ops).await
    }
    ...
    pub async fn add_bidirectional_related_memory<S: Into<String>>(
        ...
        self.graph.add_bidirectional_related_memory(parent_id, content, relationship_type, memory_type, &self.memory_ops).await
    }
    ...
    pub async fn get_related_memories(
        ...
        self.graph.get_related_memories(memory_id, relationship_type, direction).await
    }
    ...
    pub async fn find_related_entities(
        ...
        self.entities.find_related_entities(entity_id, relationship_type, direction).await
    }
    ...
    pub async fn get_memories_by_priority(
        ...
        self.entities.get_memories_by_priority(priority, limit).await
    }
    ...
    pub async fn create_relationship_entity(&self, relationship: Relationship) -> Result<Relationship> {
        self.relationships.storage().create_relationship(relationship).await
    ...
    pub async fn get_relationship(&self, id: &str) -> Result<Option<Relationship>> {
        self.relationships.storage().get_relationship(id).await
    ...
    pub async fn update_relationship(&self, relationship: Relationship) -> Result<Relationship> {
        self.relationships.storage().update_relationship(relationship).await
    ...
    pub async fn delete_relationship(&self, id: &str) -> Result<bool> {
        self.relationships.storage().delete_relationship(id).await
    ...
    pub async fn list_relationships(
        ...
        self.relationships.storage().list_relationships(filter, limit, offset).await
    ...
    pub async fn count_relationships(&self, filter: Option<RelationshipFilter>) -> Result<usize> {
        self.relationships.storage().count_relationships(filter).await
    ...
    pub async fn store_message(&self, message: &crate::messaging::types::Message) -> Result<String> {
        self.messaging.store_message(message, &self.memory_ops).await
    }
    ...
    pub async fn clear_storage(&self) -> Result<()> {
        self.memory_ops.storage().clear_storage().await
